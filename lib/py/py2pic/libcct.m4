...
* Circuit_macros Version 9.1.3, copyright (c) 2020 J. D. Aplevich under      *
...
`$3']')
                                ...
                                `relay(npoles,chars,[L|R])
                                 ...
                                 arg3: deprecated, kept for compatibility
                                   L = drawn left (default)
                                   R = drawn right '
define(`relay',`[ define(`m4pm',`ifinstr(`$2',R,-,`$3',R,-)')
V1: Here
  L1: line to rvec_(dimen_/5,0)
  Box: lbox(dimen_/5,dimen_/2)
  ifinstr(`$2',T,
   `{move to rvec_(-dimen_/10,0)
...
V2: Here
  contacts(ifelse(`$1',,1,`$1'),D`$2'ifinstr(`$3',R,R)) \
    with .O1 at V2+vec_(0,m4pm (dimen_/4+dimen_/5))
...
define(`contact',`[ dnl
  ...
  O: T+vec_(dimen_/5,-(m4pm dotrad_)) # these two needed by relay and contacts
  C: T+vec_(dimen_/5,m4pm dotrad_)
  ifinstr(`$1',P,`ifinstr(`$1',I,
   ...
   `A: line from P to P+vec_(dimen_/2,0) chop m4dr chop 0
    ifinstr(`$1',O,,`move to T ifinstr(`$1',P,`+vec_(0,m4pm`'dimen_/8)')
     ifinstr(`$1',I,
     `C: dot(at rvec_(0,m4pm`'(m4dr`'ifinstr(`$1',P,*2)+lthick/2)),m4dr,1)',
     `AC: arrow m4c_l <- ht dimen_/6 wid dimen_/6 \
       to rvec_(0,m4pm`'dimen_/4) \
       then to rvec_(dimen_/5,m4pm`'dimen_/4)
      C: Here')')
    ifinstr(`$1',C,,`move to T+vec_(0,-(m4pm`'dimen_/8))
     ifinstr(`$1',I,
